				...
				{cocktail && (
					...
					>
						...
						{cocktail.isPrevCocktail && (
							<button
								onClick={() => setCocktailId((prevId) => prevId - 1)}
								className='cocktailpopup__button'
							>
								<MdOutlineKeyboardArrowLeft className='cocktailpopup__icon' />
							</button>
						)}
						{cocktail.isNextCocktail && (
							<button
								onClick={() => setCocktailId((prevId) => prevId + 1)}
								className='cocktailpopup__button cocktailpopup__button--right'
							>
								<MdOutlineKeyboardArrowRight className='cocktailpopup__icon' />
							</button>
						)}
					</motion.div>
				)}
