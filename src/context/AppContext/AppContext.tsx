...
export const AppProvider = ({ children }: AppProviderProps) => {
	...
	// 	dispatch({ type: CLOSE_TOPSLIDER_AS_USER });
	// }, []);
	...
	// 	if (!appState.isTopSliderClosed && window.pageYOffset < topSliderHeight) {
	// 		closeTopSlider();
	// 	}
